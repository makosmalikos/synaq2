...
export default function Landing({ onStart }) {
  ...
  // Уақыт белгісі (timestamp, '1' емес): ортақ/қоғамдық компьютерде адам
  // осында басып, тіркеуден бас тартса, белгі localStorage-те қалып қояды —
  // содан кейін СОЛ БРАУЗЕРДЕ басқа ата-ана тіркелсе, оған да төлем беті
  // ашылып кетер еді. Parent.jsx белгіні тек жақын арада қойылған болса
  // ғана құрметтейді (қараңыз: WANT_PRO_TTL_MS).
